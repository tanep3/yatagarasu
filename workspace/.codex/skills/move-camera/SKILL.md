...
# 上に30度向ける
SKILL_PATH/scripts/ptz_control.sh --up

# 下に30度向ける
SKILL_PATH/scripts/ptz_control.sh --down
```
...
SKILL_PATH/scripts/ptz_control.sh --move 100 50

# 中央に戻す
SKILL_PATH/scripts/ptz_control.sh --move 0 0
```
...
```bash
# モーターキャリブレーション
SKILL_PATH/scripts/ptz_control.sh --calibrate

# モーター能力を取得
SKILL_PATH/scripts/ptz_control.sh --capability
```
